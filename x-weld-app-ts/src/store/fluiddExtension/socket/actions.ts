...
import { SocketActions } from '@/fluiddExtension/api/socketActions'
// import { EventBus, FlashMessageTypes } from '@/eventBus'
import { upperFirst, camelCase } from 'lodash-es'
import IsKeyOf from '@/fluiddExtension/util/is-key-of'
import { MainState } from '@/store/types'
import { socketClient } from '@/main'

let retryTimeout: number

export const actions: ActionTree<SocketState, MainState> = {
    /**
     * Reset our store
     */
    async reset({ commit }) {
